 ...
 * @property Doctrine_Collection $JobeetCategory
 ...
 * @method Doctrine_Collection getJobeetCategory()          Returns the current record's "JobeetCategory" collection
 ...
 * @method JobeetAffiliate     setJobeetCategory()          Sets the current record's "JobeetCategory" collection
...
abstract class BaseJobeetAffiliate extends sfDoctrineRecord
{
    ...
    {
        parent::setUp();
        $this->hasMany('JobeetCategory', array(
